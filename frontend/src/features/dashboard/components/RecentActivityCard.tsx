...
const getCategoryDetails = (category: string) => {
  ...
  switch (cat) {
    ...
    case 'household':
    case 'cleaning':
      return { icon: <IconHome2 size={18} />, badgeClass: 'household', label: 'Cleaning & Household' };
    default:
...
export const RecentActivityCard: React.FC = () => {
  ...
  return (
    <DataCard
      ...
      isLoading={isLoading}
      isEmpty={displayExpenses.length === 0}
      className="flex flex-col h-full min-h-[460px] shadow-sm select-none"
      skeleton={
