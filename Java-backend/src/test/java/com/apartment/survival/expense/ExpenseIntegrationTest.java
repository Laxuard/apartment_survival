        ...
        class ExpenseLifecycleFlowTests {
                ...
                void fullFinancialFlow() throws Exception {
                        ...
                        HouseholdResponse.Summary household = objectMapper.readValue(
                                        householdResult.getResponse().getContentAsString(),
                        ...
                        // 3. Alice logs a 300.00 MAD Groceries Expense split EQUAL among Alice, Bob,
                        // Charlie
                        var expenseRequest = new ExpenseRequest.Create(
                                        ...
                                        List.of(
                                                        ...
                                                        new ExpenseRequest.SplitItem(charlie.userId(), null, null,
                                                                        null)));
                        ...
                        // 4. Bob checks household balances -> Alice is owed 200, Bob owes 100, Charlie
                        // owes 100
                        ...
                        BalanceResponse.HouseholdBalances balances = objectMapper.readValue(
                                        ...
                                        BalanceResponse.HouseholdBalances.class);
                        ...
                        var netMap = balances.members().stream()
                                        .collect(java.util.stream.Collectors.toMap(BalanceResponse.UserBalance::userId,
                                                        BalanceResponse.UserBalance::netBalance));
                        ...
                        BalanceResponse.HouseholdBalances updatedBalances = objectMapper.readValue(
                                        updatedBalanceResult.getResponse().getContentAsString(),
                                        BalanceResponse.HouseholdBalances.class);
