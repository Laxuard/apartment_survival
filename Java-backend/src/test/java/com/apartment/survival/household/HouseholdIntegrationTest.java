...
class HouseholdIntegrationTest {
    ...
    class LifecycleTests {
        ...
        void fullHouseholdLifecycle() throws Exception {
            // 1. Register User A
            var sessionA = (org.springframework.mock.web.MockHttpSession) registerAndLogin("alice@test.com", "Alice", "Password123!");

            // 2. User A creates Household
            var createRequest = new HouseholdRequest.Create("Sunshine Villa", "Beachside Apartment", Currency.getInstance("MAD"), null);
            ...
            HouseholdResponse.Summary created = objectMapper.readValue(responseJson, HouseholdResponse.Summary.class);
            ...
            var updateRequest = new HouseholdRequest.Update("Sunny Villa Renovated", "New Description", null, null, null, 8);
    ...
    class MultiTenancySecurityTests {
        ...
        void nonMember_ForbiddenAccess() throws Exception {
            ...
            HouseholdResponse.Summary created = objectMapper.readValue(createResult.getResponse().getContentAsString(), HouseholdResponse.Summary.class);
            UUID householdId = created.householdId();

            // User B registers
            var sessionB = (org.springframework.mock.web.MockHttpSession) registerAndLogin("bob@test.com", "Bob", "Password123!");
