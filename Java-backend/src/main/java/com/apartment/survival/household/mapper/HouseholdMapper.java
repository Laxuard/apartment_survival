...
public interface HouseholdMapper {
    ...
    @Mapping(target = "defaultSplitMethod", source = "household.defaultSplitMethod")
    @Mapping(target = "defaultSplitAllocations", source = "household.defaultSplitAllocations")
    ...
    @Mapping(target = "defaultSplitMethod", defaultExpression = "java(request.defaultSplitMethod() != null ? request.defaultSplitMethod() : \"EQUAL\")")
    @Mapping(target = "defaultSplitAllocations", source = "defaultSplitAllocations")
